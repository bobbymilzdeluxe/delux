  ...
  <div>
    <VCard flat class="pa-3 pa-md-5 py-3 scrolls">
      <div class="mx-1 d-flex justify-space-between align-center">
        ...
        >
          {{ verify && verify.fullName }} Identification Document -
          <span
            ><VChip
              outlined
              label
              ...
              small
              :color="colors[verify && verify.documentStatus]"
              >{{
                verify && verify.documentStatus
                  ? verify && verify.documentStatus
                  : 'Loading'
              }}</VChip
            ></span
      ...
      <VDivider
        class="mb-5 mt-2"
        :class="colors[verify && verify.documentStatus]"
      />
      <v-row class="mx-0 px-0" justify="center">
        <VCol cols="12" md="8" v-if="!verify.documentStatus">
      ...
      <v-row class="mx-0 px-0 mt-4" justify="center" v-if="verify != null">
        <VCol cols="12">
          <VCard flat :loading="verify.frontImage ? null : 'accent'">
            <v-img
              contain
              :src="verify.frontImage"
        ...
        <VCol cols="12">
          <VCard flat :loading="verify.backImage ? null : 'accent'">
            <v-img
              contain
              :src="verify.backImage"
              class="mx-auto text-center"
              width="300"
            >
            </v-img>
