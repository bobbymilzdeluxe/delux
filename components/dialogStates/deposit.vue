    ...
    <VCard flat class="pa-3 pa-md-5 py-3 scrolls">
      ...
      <v-row class="mx-0 px-0">
        ...
        <VCol cols="12" v-if="transact.symbolAmount">
          ...
          >
            <VCardText class="d-flex justify-space-between">
              <p class="ma-0 pa-0">Deposit Amount</p>
              <p class="ma-0 pa-0 grey--text text--darken-3">
                {{ transact.symbolAmount }}.00
              </p>
            </VCardText>
        ...
        <v-row
          ...
          justify="center"
          v-if="transact.proof && user && user.role == 'admin'"
        >
          <VCol cols="12">
            <p class="accent--text text-capitalize text-center">
              Wait until the Proof of payment loads
            </p>
          </VCol>
          <VCol cols="12">
            <VCard flat :loading="transact.proof ? null : 'accent'">
              <v-img
                contain
                :src="transact.proof"
